    ...
    toggleButtons.forEach(button => {
        button.addEventListener('click', function(event) {
            ...
            if (input.type === 'password') {
                input.type = 'text';
                this.innerHTML = `<img src="/src/assets/img/icons/eye-off.svg" width="16" height="16" alt="hide">`;
            } else {
                input.type = 'password';
                this.innerHTML = `<img src="/src/assets/img/icons/eye.svg" width="16" height="16" alt="show">`;
            }
        });
